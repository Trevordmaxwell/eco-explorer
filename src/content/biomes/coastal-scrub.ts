...
export const coastalScrubBiome: BiomeDefinition = {
  ...
  terrainRules: {
    ...
    authoredEntities: [
      ...
      {
        id: 'forest-edge-release-rose',
        entryId: 'nootka-rose',
        x: 506,
        y: 108,
      },
      {
        id: 'forest-edge-release-mouse',
        entryId: 'deer-mouse',
        x: 516,
        y: 116,
      },
      {
        id: 'forest-edge-berry-salmonberry',
        entryId: 'salmonberry',
        x: 532,
        y: 108,
      },
      {
        id: 'forest-edge-berry-sparrow',
        entryId: 'song-sparrow',
        x: 552,
        y: 98,
      },
      {
        id: 'forest-edge-fern-tuck',
        entryId: 'sword-fern',
        x: 562,
        y: 108,
      },
  ...
  ecosystemNotes: [
    ...
    },
    {
      ...
      minimumDiscoveries: 3,
      summary:
        'Low fruit, rose hips, and edge berries give small mammals food beside cover.',
      observationPrompt:
        'Where do berries sit close to cover?',
    },
    {
