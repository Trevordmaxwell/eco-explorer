...
export const forestBiome: BiomeDefinition = {
  ...
  terrainRules: {
    ...
    authoredEntities: [
      ...
      {
        id: 'source-memory-release-seep-moss',
        entryId: 'seep-moss-mat',
        x: 590,
        y: 112,
        castsShadow: false,
      ...
      {
        id: 'source-memory-release-root-curtain',
        entryId: 'root-curtain',
        x: 610,
        y: 116,
        castsShadow: false,
