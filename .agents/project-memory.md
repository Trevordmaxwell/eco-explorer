...
- Fresh lane agents should read `.agents/fresh-lane-start.md` after `AGENTS.md`; it stores the current director gate, lane-specific copy-paste prompts, and the reasoning-effort defaults for lane 1 through lane 4.
...
- For the long-running four-lane push, lane boundaries are strict: lane 1 owns state/station/tooling, lane 2 owns science/copy/notebook content, lane 3 owns physical spaces and visual proof, and lane 4 owns Route v2/support/replay behavior; shared files require an explicit handoff note before another lane edits them.
