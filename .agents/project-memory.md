...
- The current active strategic priority is to deepen `High Pass` into a full chapter before broadening scope again: one smaller chapter-state seam, one relationship-first ecology pass, one more remembered place, and one sharper replay/support difference are the highest-leverage next wins.
...
- High Pass deepening should refine the current chapter rather than open a second High Pass route, a broader planner shell, season three, or biome six.
- Do not spend the immediate next wave on broader Beach, Treeline, or nursery surgery work unless a real regression appears; the better spend is chapter depth and maintainability inside the live High Pass shell.
