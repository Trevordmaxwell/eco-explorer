...
- The first high-country local-support follow-on is now live as one `talus-cushion-pocket` close-look card plus one `frost-heave-hummock` sketchbook note; later treeline and tundra follow-ons should treat that as the current notebook-facing density ceiling and switch carriers or surfaces before stacking more copy into those same compact seams.
